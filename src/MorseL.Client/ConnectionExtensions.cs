...
namespace MorseL.Client
{
    ...
    {
        public static void On(this IConnection connection, string methodName, Action onData)
        {
        ...
        public static void On<T1>(this IConnection connection, string methodName, Action<T1> onData)
        {
        ...
        public static void On<T1, T2>(this IConnection connection, string methodName, Action<T1, T2> onData)
        {
        ...
        public static void On<T1, T2, T3>(this IConnection connection, string methodName, Action<T1, T2, T3> onData)
        {
        ...
        public static void On<T1, T2, T3, T4>(this IConnection connection, string methodName, Action<T1, T2, T3, T4> onData)
        {
        ...
        public static void On<T1, T2, T3, T4, T5>(this IConnection connection, string methodName, Action<T1, T2, T3, T4, T5> onData)
        {
